...
function [tspan, y] = prsolve_rk4(T,params)
...
dt2 = dt/2;
for i = 2:n_tspan
    dy1 = dt2*red(tspan(i-1),yc,Is,Id,gc);
    dy2 = dt2*red(tspan(i-1)+dt2,yc+dy1,Is,Id,gc);
    dy3 = dt2*red(tspan(i-1)+dt2,yc+dy2,Is,Id,gc);
    dy4 = dt2*red(tspan(i-1)+dt,yc+2*dy3,Is,Id,gc);
